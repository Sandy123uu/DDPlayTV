...
|---|---|---|---|---|---|---|---|---|---|---|
| STORAGE-F001 | Duplication | ... | `path/to/File.kt` + `Foo#bar` | Unintentional | Unify | `:core_xxx_component` | High | Small | P1 | ... |

## 4) Refactor Tasks（治理任务）

| ID | 关联 Finding | 目标 | 范围 | 验收标准 | Impact | Effort | P | 负责人 | 状态 |
|---|---|---|---|---|---|---|---|---|---|
| STORAGE-T001 | STORAGE-F001 | ... | ... | ... | High | Small | P1 | ... | Draft |
