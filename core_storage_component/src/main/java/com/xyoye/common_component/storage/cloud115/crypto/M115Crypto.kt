...
object M115Crypto {
    ...
    internal val xorKeySeed: ByteArray =
        byteArrayOf(
            0xf0.toByte(), 0xe5.toByte(), 0x69.toByte(), 0xae.toByte(), 0xbf.toByte(), 0xdc.toByte(), 0xbf.toByte(), 0x8a.toByte(),
            0x1a.toByte(), 0x45.toByte(), 0xe8.toByte(), 0xbe.toByte(), 0x7d.toByte(), 0xa6.toByte(), 0x73.toByte(), 0xb8.toByte(),
            0xde.toByte(), 0x8f.toByte(), 0xe7.toByte(), 0xc4.toByte(), 0x45.toByte(), 0xda.toByte(), 0x86.toByte(), 0xc4.toByte(),
            0x9b.toByte(), 0x64.toByte(), 0x8b.toByte(), 0x14.toByte(), 0x6a.toByte(), 0xb4.toByte(), 0xf1.toByte(), 0xaa.toByte(),
            0x38.toByte(), 0x01.toByte(), 0x35.toByte(), 0x9e.toByte(), 0x26.toByte(), 0x69.toByte(), 0x2c.toByte(), 0x86.toByte(),
            0x00.toByte(), 0x6b.toByte(), 0x4f.toByte(), 0xa5.toByte(), 0x36.toByte(), 0x34.toByte(), 0x62.toByte(), 0xa6.toByte(),
            0x2a.toByte(), 0x96.toByte(), 0x68.toByte(), 0x18.toByte(), 0xf2.toByte(), 0x4a.toByte(), 0xfd.toByte(), 0xbd.toByte(),
            0x6b.toByte(), 0x97.toByte(), 0x8f.toByte(), 0x4d.toByte(), 0x8f.toByte(), 0x89.toByte(), 0x13.toByte(), 0xb7.toByte(),
            0x6c.toByte(), 0x8e.toByte(), 0x93.toByte(), 0xed.toByte(), 0x0e.toByte(), 0x0d.toByte(), 0x48.toByte(), 0x3e.toByte(),
            0xd7.toByte(), 0x2f.toByte(), 0x88.toByte(), 0xd8.toByte(), 0xfe.toByte(), 0xfe.toByte(), 0x7e.toByte(), 0x86.toByte(),
            0x50.toByte(), 0x95.toByte(), 0x4f.toByte(), 0xd1.toByte(), 0xeb.toByte(), 0x83.toByte(), 0x26.toByte(), 0x34.toByte(),
            0xdb.toByte(), 0x66.toByte(), 0x7b.toByte(), 0x9c.toByte(), 0x7e.toByte(), 0x9d.toByte(), 0x7a.toByte(), 0x81.toByte(),
            0x32.toByte(), 0xea.toByte(), 0xb6.toByte(), 0x33.toByte(), 0xde.toByte(), 0x3a.toByte(), 0xa9.toByte(), 0x59.toByte(),
            0x34.toByte(), 0x66.toByte(), 0x3b.toByte(), 0xaa.toByte(), 0xba.toByte(), 0x81.toByte(), 0x60.toByte(), 0x48.toByte(),
            0xb9.toByte(), 0xd5.toByte(), 0x81.toByte(), 0x9c.toByte(), 0xf8.toByte(), 0x6c.toByte(), 0x84.toByte(), 0x77.toByte(),
            0xff.toByte(), 0x54.toByte(), 0x78.toByte(), 0x26.toByte(), 0x5f.toByte(), 0xbe.toByte(), 0xe8.toByte(), 0x1e.toByte(),
            0x36.toByte(), 0x9f.toByte(), 0x34.toByte(), 0x80.toByte(), 0x5c.toByte(), 0x45.toByte(), 0x2c.toByte(), 0x9b.toByte(),
            0x76.toByte(), 0xd5.toByte(), 0x1b.toByte(), 0x8f.toByte(), 0xcc.toByte(), 0xc3.toByte(), 0xb8.toByte(), 0xf5.toByte(),
        )

    internal val xorClientKey: ByteArray =
        byteArrayOf(
            0x78.toByte(), 0x06.toByte(), 0xad.toByte(), 0x4c.toByte(), 0x33.toByte(), 0x86.toByte(), 0x5d.toByte(), 0x18.toByte(),
            0x4c.toByte(), 0x01.toByte(), 0x3f.toByte(), 0x46.toByte(),
        )
