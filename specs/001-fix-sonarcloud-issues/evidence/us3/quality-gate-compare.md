...
- 生成时间：2026-02-08T08:41:21.266836+00:00
...
- 当前 `baselineAnalysisKey` 与 `targetAnalysisKey` 同为 `07c4be1f-f37a-418a-926f-2a13a7a15f86`，说明对比仍基于同一条分析线。
- 本文件用于固定 Phase 5 执行轨迹；进入 Phase 6 前需要使用新的分支/PR analysis key 重跑并替换本快照。
